...
public class Login extends javax.swing.JFrame {
    ...
    public Login() {
        initComponents();
        //Ubicar central el JFrame Form en la pantalla
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(201, 232, 249));
        ...
        setBackground(new java.awt.Color(188, 220, 252));
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        // Crear atributos para capturar los datos del usuario
        String userName = txtUser.getText();
        String password = txtPassword.getText();
        
        //Probar si se captura los datos
        System.out.println("Usuario " + userName + " Contraseña " + password);
        
        //Validar si hay campos vacios
        if (userName.isEmpty() || password.isEmpty()) {
            //Si se encuentra campos vacios se ejecuta ventana emergente que no
            ...
            //Validar que los datos ingresados correspondas a los de inicio de sesión
            if(userName.equals("MisionTIC") && password.equals("Ciclo2")){
                JOptionPane.showMessageDialog(this, "Bienvenido al sistema Misión TIC", "Login", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void btnCambiarPasswordActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCambiarPasswordActionPerformed
        // Crear una instancia para restablecer contraseña
